...
import { i as inspect, G as GraphQLError, d as devAssert, c as assertValidSchema, e as isObjectLike, K as Kind, f as getVariableValues, h as collectFields, O as OperationTypeNode, j as addPath, k as getArgumentValues, p as pathToArray, l as isNonNullType, m as isListType, n as isLeafType, o as isAbstractType, q as isObjectType, r as invariant, s as isIterableObject, S as SchemaMetaFieldDef, T as TypeMetaFieldDef, t as TypeNameMetaFieldDef, u as collectSubfields$1, v as parse, w as validate } from "./index-62651a21.js";
...
async function subscribe(args) {
  ...
  if (!isAsyncIterable$1(resultOrStream)) {
...
async function createSourceEventStream(...rawArgs) {
  ...
  try {
    ...
    if (!isAsyncIterable$1(eventStream)) {
      throw new Error(
    ...
    const message = /* @__PURE__ */ (() => {
      ...
      return {
        ...
        emit(message2) {
          var _a;
          if ("id" in message2)
            (_a = listeners2[message2.id]) == null ? void 0 : _a.call(listeners2, message2);
        }
      };
    })();
    const listeners = {
  ...
  return {
    opened(socket, extra) {
      ...
      return async (code, reason) => {
        ...
        if (ctx.acknowledged)
          await (onDisconnect == null ? void 0 : onDisconnect(ctx, code, reason));
        await (onClose == null ? void 0 : onClose(ctx, code, reason));
      };
    }
  };

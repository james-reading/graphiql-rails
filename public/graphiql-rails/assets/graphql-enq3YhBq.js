import { g as getDefaultExportFromCjs } from "./index-DG__pMso.js";
...
function requireGraphql() {
  if (hasRequiredGraphql) return graphql$2.exports;
  ...
  (function(module, exports) {
    (function(f) {
      ...
      var xe = (e, t) => {
        ...
        if (t && typeof t == "object" || typeof t == "function") for (let r of Tt(t)) !_t.call(e, r) && r !== n && ce(e, r, { get: () => t[r], enumerable: !(i = Et(t, r)) || i.enumerable });
        return e;
      };
...
` + me(this.source, n);
      ...
      function Qt(e, t, n) {
        ...
        if (s === 46 && (a = true, s = i.charCodeAt(++r), r = Te(e, r, s), s = i.charCodeAt(r)), (s === 69 || s === 101) && (a = true, s = i.charCodeAt(++r), (s === 43 || s === 45) && (s = i.charCodeAt(++r)), r = Te(e, r, s), s = i.charCodeAt(r)), s === 46 || Ee(s)) throw d(e.source, r, `Invalid number, expected digit but got: ${R(e, r)}.`);

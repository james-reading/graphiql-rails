...
import { g as getDefaultExportFromCjs } from "./index-62651a21.js";
...
(function(module, exports) {
  (function(f) {
    ...
    var xe = (e, t) => {
      for (var n in t)
        ce(e, n, { get: t[n], enumerable: true });
    }, Nt = (e, t, n, i) => {
      if (t && typeof t == "object" || typeof t == "function")
        for (let r of Tt(t))
          !_t.call(e, r) && r !== n && ce(e, r, { get: () => t[r], enumerable: !(i = Et(t, r)) || i.enumerable });
      return e;
    };
    var xt = (e) => Nt(ce({}, "__esModule", { value: true }), e);
    var En = {};
    ...
    function N(e) {
      return { type: j, contents: e };
    }
    function y(e, t = {}) {
      return pe(t.expandedStates), { type: $, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates };
    }
    function I(e, t = "", n = {}) {
      return { type: w, breakContents: e, flatContents: t, groupId: n.groupId };
    }
    var Dt = { type: X };
    var gt = { type: S, hard: true };
    var k = { type: S }, p = { type: S, soft: true }, f = [gt, Dt];
    function E(e, t) {
      let n = [];
      for (let i = 0; i < t.length; i++)
        i !== 0 && n.push(e), n.push(t[i]);
      return n;
    }
    function H(e) {
      return (t, n, i) => {
...
` || r === "\r" || r === "\u2028" || r === "\u2029")
    ...
    var Pe = Ct;
    function Rt(e, t) {
      return t === false ? false : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? Le(e, t) : t;
    }
    var we = Rt;
    function vt(e, t) {
      let n = null, i = t;
      for (; i !== n; )
        n = i, i = ve(e, i), i = Pe(e, i), i = J(e, i);
      return i = we(e, i), i = q(e, i), i !== false && be(e, i);
    }
    var Fe = vt;
    function Lt(e) {
    ...
    function B(e) {
      ...
      return F = B.prototype = e ?? /* @__PURE__ */ Object.create(null), new B();
    }
    var bt = 10;
    for (let e = 0; e <= bt; e++)
      B();
    ...
    function Bt(e, t, n) {
      ...
      switch (i.kind) {
        ...
        case "OperationDefinition": {
          ...
          return [r ? i.operation : "", r && s ? [" ", n("name")] : "", r && !s && fe(i.variableDefinitions) ? " " : "", He(e, n), x(e, n, i), !r && !s ? "" : " ", n("selectionSet")];
        }
        case "FragmentDefinition":
          return ["fragment ", n("name"), He(e, n), " on ", n("typeCondition"), x(e, n, i), " ", n("selectionSet")];
        case "SelectionSet":
          return ["{", N([f, E(f, g(e, t, n, "selections"))]), f, "}"];
        case "Field":
          return y([i.alias ? [n("alias"), ": "] : "", n("name"), i.arguments.length > 0 ? y(["(", N([p, E([I("", ", "), p], g(e, t, n, "arguments"))]), p, ")"]) : "", x(e, n, i), i.selectionSet ? " " : "", n("selectionSet")]);
        case "Name":
          return i.value;
        case "StringValue":
          if (i.block) {
...
`, String.raw`\n`), '"'];
        ...
        case "Directive":
          return ["@", n("name"), i.arguments.length > 0 ? y(["(", N([p, E([I("", ", "), p], g(e, t, n, "arguments"))]), p, ")"]) : ""];
        case "NamedType":
          return n("name");
        ...
        case "InterfaceTypeDefinition": {
          let { kind: r } = i, s = [];
          return r.endsWith("TypeDefinition") ? s.push(D(e, t, n)) : s.push("extend "), r.startsWith("ObjectType") ? s.push("type") : r.startsWith("InputObjectType") ? s.push("input") : s.push("interface"), s.push(" ", n("name")), !r.startsWith("InputObjectType") && i.interfaces.length > 0 && s.push(" implements ", ...Vt(e, t, n)), s.push(x(e, n, i)), i.fields.length > 0 && s.push([" {", N([f, E(f, g(e, t, n, "fields"))]), f, "}"]), s;
        }
        case "FieldDefinition":
          return [D(e, t, n), n("name"), i.arguments.length > 0 ? y(["(", N([p, E([I("", ", "), p], g(e, t, n, "arguments"))]), p, ")"]) : "", ": ", n("type"), x(e, n, i)];
        case "DirectiveDefinition":
          return [D(e, t, n), "directive ", "@", n("name"), i.arguments.length > 0 ? y(["(", N([p, E([I("", ", "), p], g(e, t, n, "arguments"))]), p, ")"]) : "", i.repeatable ? " repeatable" : "", " on ", ...E(" | ", e.map(n, "locations"))];
        case "EnumTypeExtension":
        case "EnumTypeDefinition":
          return [D(e, t, n), i.kind === "EnumTypeExtension" ? "extend " : "", "enum ", n("name"), x(e, n, i), i.values.length > 0 ? [" {", N([f, E(f, g(e, t, n, "values"))]), f, "}"] : ""];
        case "EnumValueDefinition":
          return [D(e, t, n), n("name"), x(e, n, i)];
        case "InputValueDefinition":
          return [D(e, t, n), n("name"), ": ", n("type"), i.defaultValue ? [" = ", n("defaultValue")] : "", x(e, n, i)];
        case "SchemaExtension":
          return ["extend schema", x(e, n, i), ...i.operationTypes.length > 0 ? [" {", N([f, E(f, g(e, t, n, "operationTypes"))]), f, "}"] : []];
        case "SchemaDefinition":
          return [D(e, t, n), "schema", x(e, n, i), " {", i.operationTypes.length > 0 ? N([f, E(f, g(e, t, n, "operationTypes"))]) : "", f, "}"];
        ...
        case "UnionTypeDefinition":
          return y([D(e, t, n), y([i.kind === "UnionTypeExtension" ? "extend " : "", "union ", n("name"), x(e, n, i), i.types.length > 0 ? [" =", I("", " "), N([I([k, "| "]), E([k, "| "], e.map(n, "types"))])] : ""])]);
        case "ScalarTypeExtension":
        case "ScalarTypeDefinition":
          return [D(e, t, n), i.kind === "ScalarTypeExtension" ? "extend " : "", "scalar ", n("name"), x(e, n, i)];
        case "NonNullType":
          return [n("type"), "!"];
        case "ListType":
          return ["[", n("type"), "]"];
    ...
    function He(e, t) {
      let { node: n } = e;
      return fe(n.variableDefinitions) ? y(["(", N([p, E([I("", ", "), p], e.map(t, "variableDefinitions"))]), p, ")"]) : "";
    }
    function Je(e, t) {
...
`) && (t.value = e.value.trim());
    ...
    var Gt = { print: Bt, massageAstNode: Je, hasPrettierIgnore: Yt, insertPragma: Xe, printComment: Mt, canAttachComment: Ut, getVisitorKeys: Me }, qe = Gt;
    ...
    var jt = { bracketSpacing: We.bracketSpacing }, Ke = jt;
    var Ne = {};
    xe(Ne, { graphql: () => dn });
    function ze(e) {
...
`);
    ...
    var Z = class e extends Error {
      constructor(t, ...n) {
        var i, r, s;
        let { nodes: a, source: u, positions: l, path: T, originalError: h, extensions: A } = Xt(n);
...
` + me(this.source, n);
    ...
    function Ht(e) {
      let t = 0;
      for (; t < e.length && rt(e.charCodeAt(t)); )
        ++t;
      return t;
    }
    var o;
    ...
    function Jt(e, t) {
      ...
      for (; r < i; ) {
        ...
        switch (s) {
          ...
          case 34:
            return n.charCodeAt(r + 1) === 34 && n.charCodeAt(r + 2) === 34 ? en(e, r) : Wt(e, r);
        }
        if (b(s) || s === 45)
          return Qt(e, r, s);
        if (Ee(s))
    ...
    function Qt(e, t, n) {
      ...
      if (s === 45 && (s = i.charCodeAt(++r)), s === 48) {
        ...
        r = Te(e, r, s), s = i.charCodeAt(r);
      if (s === 46 && (a = true, s = i.charCodeAt(++r), r = Te(e, r, s), s = i.charCodeAt(r)), (s === 69 || s === 101) && (a = true, s = i.charCodeAt(++r), (s === 43 || s === 45) && (s = i.charCodeAt(++r)), r = Te(e, r, s), s = i.charCodeAt(r)), s === 46 || Ee(s))
        throw d(e.source, r, `Invalid number, expected digit but got: ${R(e, r)}.`);
      return m(e, a ? o.FLOAT : o.INT, t, r, i.slice(t, r));
    }
    function Te(e, t, n) {
      if (!b(n))
        throw d(e.source, t, `Invalid number, expected digit but got: ${R(e, t)}.`);
    ...
    function Wt(e, t) {
      ...
      for (; r < i; ) {
        ...
        if (u === 34)
          return a += n.slice(s, r), m(e, o.STRING, t, r + 1, a);
        if (u === 92) {
          a += n.slice(s, r);
          let l = n.charCodeAt(r + 1) === 117 ? n.charCodeAt(r + 2) === 123 ? Kt(e, r) : zt(e, r) : Zt(e, r);
        ...
        if (P(u))
          ...
          throw d(e.source, r, `Invalid character within String: ${R(e, r)}.`);
      }
...
`));
        ...
        if (P(T))
          ...
          throw d(e.source, s, `Invalid character within String: ${R(e, s)}.`);
      }
    ...
    function sn(e, t) {
      ...
      return n.length === 0 ? "{}" : t.length > 2 ? "[" + an(e) + "]" : "{ " + n.map(([r, s]) => r + ": " + se(s, t)).join(", ") + " }";
    }
    function on(e, t) {
      if (e.length === 0)
        return "[]";
    ...
    var cn = globalThis.process && true, pt = cn ? function(t, n) {
...
spurious results.`);
    ...
    function ht(e, t) {
      let n = new _e(e, t), i = n.parseDocument();
    ...
    var pn = { allowLegacyFragmentVariables: true };
    function fn(e) {
    ...
    var dn = { parse: hn, astFormat: "graphql", hasPragma: je, hasIgnorePragma: $e, locStart: K, locEnd: z };
    var mn = { graphql: qe };
    return xt(En);
  });
})(graphql$2);
var graphqlExports = graphql$2.exports;
